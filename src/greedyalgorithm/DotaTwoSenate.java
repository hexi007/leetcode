...
/**
 * description Dota2 的世界里有两个阵营：Radiant(天辉)和 Dire(夜魇)  Dota2 参议院由来自两派的参议员组成。
 * 现在参议院希望对一个 Dota2 游戏里的改变作出决定。
 * 他们以一个基于轮为过程的投票进行。在每一轮中，每一位参议员都可以行使两项权利中的一项：
 * 1.禁止一名参议员的权利：  参议员可以让另一位参议员在这一轮和随后的几轮中丧失所有的权利。  2.
 ...
 *
 * @author 27771
 * create 2020-12-11 09:53
 **/
public class DotaTwoSenate {

    static class Solution {

        LinkedList<Integer> radiant;
        LinkedList<Integer> dire;

        /**
         * 双队列模拟两个阵营
         * (执行用时：11 ms, 在所有 Java 提交中击败了53.88%的用户)
         * (内存消耗：38.6 MB, 在所有 Java 提交中击败了82.81%的用户)
         *
         * @param senate 代表每个参议员阵营的字符串
         * @return       获胜方
         */
        public String predictPartyVictory(String senate) {
            ...
            while (!radiant.isEmpty() && !dire.isEmpty()) {
                ...
                // 位置较大的被取消所有权利，另一个后移总阵营长度后加到自己阵营末尾
